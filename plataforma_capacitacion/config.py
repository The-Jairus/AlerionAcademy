...
# Cuando Caddy entrega los videos directamente desde el disco (MEDIA_DIRECT=1),
# la aplicación solo autoriza el acceso y queda libre para atender a los demás.
MEDIA_DIRECTO = os.environ.get("MEDIA_DIRECT") == "1"
MEDIA_PREFIJO = "/media"
