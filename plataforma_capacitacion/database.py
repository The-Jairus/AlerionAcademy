...
def migrar(con):
    ...
    # 2. Los quices pasan de colgar del curso a colgar del módulo.
    ...
    # 3. Columnas nuevas en tablas que ya existían.
    ...
    # 4. El avance por curso se replica al módulo 1, para no perder progreso.
